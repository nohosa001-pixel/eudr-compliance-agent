    ...
    def assemble_report(
        ...
        return DDSReport(
            ...
            legal_summary={
                ...
                "outermost_region_exemption_applied": getattr(legal_audit, "outermost_region_exemption_applied", False),
                "transshipment_risk_flag": getattr(legal_audit, "transshipment_risk_flag", False),
                "omr_defense_statement": getattr(legal_audit, "omr_defense_statement", None),
